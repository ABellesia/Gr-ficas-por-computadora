...
"void main()\n"
"{\n"
"   FragColor = vec4(0.36f, 0.0f, 0.11f, 1.0f); \n"
"}\n\0";
//Negro
...
"void main()\n"
"{\n"
"   FragColor = vec4(0.3f, 0.521f, 0.25f, 1.0f); \n"
"}\n\0";
...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Tarea 2: Andrea Bellesia 188642", NULL, NULL);
    if (window == NULL)
    {
    ...
    float vertices[] = {
        // positions          // colors           // texture coords
         0.2f, -0.2f, 0.0f,   1.0f, 0.0f, 0.0f,   1.0f, 1.0f, // top right //se hace una correspondencia entre las coordenadas de la figura y de la textura
    ...
    unsigned int fragmentShader9 = glCreateShader(GL_FRAGMENT_SHADER); // Polígono
    ...
    unsigned int fragmentShader29 = glCreateShader(GL_FRAGMENT_SHADER); // Circ 1
    unsigned int fragmentShader30 = glCreateShader(GL_FRAGMENT_SHADER); // Circ 2
    unsigned int fragmentShader31 = glCreateShader(GL_FRAGMENT_SHADER); // Circ 3
    unsigned int fragmentShader32 = glCreateShader(GL_FRAGMENT_SHADER); // Circ 4
    unsigned int fragmentShader33 = glCreateShader(GL_FRAGMENT_SHADER); // Circ 5
    unsigned int fragmentShader34 = glCreateShader(GL_FRAGMENT_SHADER); // Circ 6
    unsigned int fragmentShader35 = glCreateShader(GL_FRAGMENT_SHADER); // Circ 7
    unsigned int fragmentShader36 = glCreateShader(GL_FRAGMENT_SHADER); // Circ 8
    ...
    unsigned int shaderProgram29 = glCreateProgram(); // Circ 1
    unsigned int shaderProgram30 = glCreateProgram(); // Circ 2
    unsigned int shaderProgram31 = glCreateProgram(); // Circ 3
    unsigned int shaderProgram32 = glCreateProgram(); // Circ 4
    unsigned int shaderProgram33 = glCreateProgram(); // Circ 5
    unsigned int shaderProgram34 = glCreateProgram(); // Circ 6
    unsigned int shaderProgram35 = glCreateProgram(); // Circ 7
    unsigned int shaderProgram36 = glCreateProgram(); // Circ 8
    ...
    //Circ 1
    glShaderSource(fragmentShader29, 1, &fragmentShader1Source, NULL);
    glCompileShader(fragmentShader29);
    //Circ 2
    glShaderSource(fragmentShader30, 1, &fragmentShader4Source, NULL);
    glCompileShader(fragmentShader30);
    //Circ 3
    glShaderSource(fragmentShader31, 1, &fragmentShader1Source, NULL);
    glCompileShader(fragmentShader31);
    //Circ 4
    glShaderSource(fragmentShader32, 1, &fragmentShader4Source, NULL);
    glCompileShader(fragmentShader32);
    //Circ 5
    glShaderSource(fragmentShader33, 1, &fragmentShader1Source, NULL);
    glCompileShader(fragmentShader33);
    //Circ 6
    glShaderSource(fragmentShader34, 1, &fragmentShader4Source, NULL);
    glCompileShader(fragmentShader34);
    //Circ 7
    glShaderSource(fragmentShader35, 1, &fragmentShader1Source, NULL);
    glCompileShader(fragmentShader35);
    //Circ 8
    glShaderSource(fragmentShader36, 1, &fragmentShader4Source, NULL);
    ...
    float Tri1[] = {
        ...
        -0.7f, 1.0f, 0.0f, //arriba
        -0.7f, 0.7f, 0.0f //abajo
    };
    float Tri2[] = {
        -1.0f, 1.0f, 0.0f, //esquina
        -1.0f, 0.7f, 0.0f, //izquierda
        -0.7f, 0.7f, 0.0f  //derecha
    };
    float Tri3[] = {
        1.0f, 1.0f, 0.0f, //esquina
        0.7f, 1.0f, 0.0f, //arriba
    ...
    float Tri4[] = {
        1.0f, 1.0f, 0.0f, //esquina
        1.0f, 0.7f, 0.0f, //derecha
        0.7f, 0.7f, 0.0f  //izquierda
    };
    float Tri5[] = {
        1.0f, -1.0f, 0.0f, //esquina
        1.0f, -0.7f, 0.0f, //derecha
        0.7f, -0.7f, 0.0f //izaquierda
    };
    float Tri6[] = {
        1.0f, -1.0f, 0.0f, //esquina
        0.7f, -1.0f, 0.0f, //abajo
        0.7f, -0.7f, 0.0f //arriba
    };
    float Tri7[] = {
        -1.0f, -1.0f, 0.0f, //esquina
        -0.7f, -1.0f, 0.0f, //abajo
    ...
    float Cuad3[] = {
        -0.35f, 0.35f, 0.0f,  //esq1
        0.35f, 0.35, 0.0f,  //esq2
        0.35f, -0.35, 0.0f,  //esq3
        -0.35f, -0.35, 0.0f  //esq4
    };
    ...
    float Circ1[] = {
        0.0f, 0.4f, 0.0f, //centro del círculo --> se van a empezar a agregar los vértices que se ocuparán
        0.0f, 0.6f, 0.0f,
        0.1f, 0.57f, 0.0f,
        0.17f, 0.5f, 0.0f,
        0.2f, 0.4f, 0.0f,
    ...
    unsigned char* data = stbi_load("C:/GpC/Image/Fondo.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
